                ...
                <div class="card-body">
                    ...
                    <form class="mt-4" action="{{route('user.store')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nome do Usuário" id="name" name="name" value="{{old('name')}}">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" placeholder="Email do Usuário" id="email" name="email" value="{{old('email')}}">
                        </div>
                        <div class="form-group">
