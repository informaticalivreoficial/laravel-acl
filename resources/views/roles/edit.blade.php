        ...
        <div class="col-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="mt-4" action="{{route('role.update', ['role' => $role->id])}}" method="post" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <button class="btn btn-lg btn-block btn-success">Atualizar Perfil</button>
                    </form>
                </div>
            </div>
        </div>
